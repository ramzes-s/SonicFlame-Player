...
- `LibraryModel`: Виртуальная модель с постраничной загрузкой (PAGE_SIZE=250). Пагинация на уровне БД. Поддержка фильтров: поиск, жанр, избранное.
...
QThread для сканирования папок. Обработка файлов последовательная (дисковый I/O и mutagen — узкое место, ThreadPoolExecutor не давал прироста).
