...
class WebServer(QObject):
    ...
    def _setup_routes(self):
        ...
        self._app.router.add_post('/api/status', api.handle_status)
        self._app.router.add_post('/api/track', api.handle_track)
        self._app.router.add_post('/api/playlist', api.handle_playlist)
        self._app.router.add_post('/api/accent_color', api.handle_accent_color)
        self._app.router.add_post('/api/playing_data', api.handle_playing_data)
        self._app.router.add_post('/api/play', api.handle_play)
        self._app.router.add_post('/api/pause', api.handle_pause)
        self._app.router.add_post('/api/next', api.handle_next)
        self._app.router.add_post('/api/previous', api.handle_previous)
        ...
        self._app.router.add_post('/api/folders', api.handle_folders)
        ...
        self._app.router.add_post('/api/toggle_repeat', api.handle_toggle_repeat)
        self._app.router.add_post('/api/play_favorites', api.handle_play_favorites)
        self._app.router.add_post('/api/play_top', api.handle_play_top)
        self._app.router.add_post('/api/play_similar', api.handle_play_similar)
        self._app.router.add_post('/api/play_artist', api.handle_play_artist)
        self._app.router.add_post('/api/check', api.handle_check)
