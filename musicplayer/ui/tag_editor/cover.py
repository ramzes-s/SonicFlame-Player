...
def _generate_abstract_cover(artist: str, title: str) -> bytes:
    ...
    try:
        ...
        arial_bold_font_path = os.path.join(os.environ["WINDIR"], "Fonts", "arialbd.ttf")
        try:
    ...
    if artist_lines:
        ...
        total_artist_height += (len(artist_lines) - 1) * 5
        ...
        for line in artist_lines:
            ...
            y_text_artist += draw.textbbox((0, 0), line, font=font_artist)[3] - draw.textbbox((0, 0), line, font=font_artist)[1] + 5
    ...
    if title_lines:
        ...
        total_title_height += (len(title_lines) - 1) * 5
        ...
        for line in title_lines:
            ...
            y_text_title += draw.textbbox((0, 0), line, font=font_title)[3] - draw.textbbox((0, 0), line, font=font_title)[1] + 5
